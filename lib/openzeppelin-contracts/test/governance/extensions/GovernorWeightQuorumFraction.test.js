  ...
  describe('quroum not reached', function () {
    beforeEach(async function () {
      this.settings = {
        ...
        tokenHolder: owner,
        voters: [{ voter: voter1, weight: web3.utils.toWei('1'), support: Enums.VoteType.For }],
        steps: {
  ...
  describe('update quorum ratio through proposal', function () {
    beforeEach(async function () {
      this.settings = {
        ...
        tokenHolder: owner,
        voters: [{ voter: voter1, weight: tokenSupply, support: Enums.VoteType.For }],
      };
    });
    afterEach(async function () {
      await expectEvent.inTransaction(this.receipts.execute.transactionHash, this.mock, 'QuorumNumeratorUpdated', {
