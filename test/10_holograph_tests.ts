...
import { Holograph, MockExternalCall, MockExternalCall__factory, MockHolographChild, Holograph__factory } from '../typechain-types'
  ...
  describe(`getHolographChainId()`, () => {
    ...
    it('Should allow external contract to call fn', async () => {
      await expect(
        mockExternalCall.functions.callExternalFn(
          holograph.address,
          encodeFunctionSignature('function getHolographChainId() external view returns (uint32 holographChainId)', 'getHolographChainId', [])
        )
      ).to.not.be.reverted
    });
  ...
  describe(`getInterfaces()`, () => {
    ...
    it('Should allow external contract to call fn', async () => {
      await expect(
        mockExternalCall.functions.callExternalFn(
          holograph.address,
          encodeFunctionSignature('function getInterfaces() external view returns (address interfaces)', 'getInterfaces', [])
        )
      ).to.not.be.reverted
    });
  ...
  describe(`getUtilityToken()`, () => {
    ...
    it('Should allow external contract to call fn', async () => {
      await expect(
        mockExternalCall.functions.callExternalFn(
          holograph.address,
          encodeFunctionSignature('function getUtilityToken() external view returns (address utilityToken)', 'getUtilityToken', [])
        )
      ).to.not.be.reverted
    });
